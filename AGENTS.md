...
- PIPELINE SYSTEM
  ...
  7.7 Go through the stages, one by one, in order. After completing each stage, write the details to the corresponding file: `01-investigate.md`, `02-plan.md`, `03-build.md`, `04-verify.md` and an extra `05-summary.md`.
