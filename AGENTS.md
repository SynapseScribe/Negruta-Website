...
- PIPELINE SYSTEM
  ...
  7.16 When asked to `abort issue <#>. reason: <xyz>` -> close issue on gh, and any existing related pull request, adding a comment with the `reason <xyz>`. Do not merge the pr in this case.
